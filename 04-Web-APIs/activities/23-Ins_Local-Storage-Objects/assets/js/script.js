...
//nside the renderMessage function, we retrieve the string and convert it back into an object with JSON.parse(). 
...
function renderMessage() {
  ...
  console.log(arr[0])//"studentGrade"

  var arrStr = localStorage.getItem("Array");
  console.log(arrStr[0])//s
  if (lastGrade !== null) {
